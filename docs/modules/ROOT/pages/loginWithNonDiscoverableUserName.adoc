...
Logs the user in using a saved passkey.
The system only displays the passkey associated with the given username in a link:https://developer.apple.com/design/human-interface-guidelines/sheets[modal sheet^].
