...
[.expand]
icon:warning[] Breaking changes for `9.0.0`, please read.

[.expand-content]
====
[discrete]
include::partial$announcements/900-breaking-changes.adoc[leveloffset=+1]
====
...
----
pod 'IdentitySdkFacebook', '~> {sdk-ios-latest-version}' <1>
----
...
[source,subs="normal,callouts"]
----
pod 'IdentitySdkFacebook', '~> {sdk-ios-facebook-latest-version}' <1>
----
