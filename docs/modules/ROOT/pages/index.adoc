...
The core SDK contains all the main tools and interfaces, and methods related to standard authentication by identifier and password, passkey, passwordless, etc.
...
+
--
Swift Package Manager not yet supported.
--
====
