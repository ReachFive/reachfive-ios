...
// [.d-post]#*CocoaPods* `{sdk-ios-latest-version}`#
image:https://img.shields.io/cocoapods/v/IdentitySdkCore.svg?style=flat&color=green[]
...
{company} SDKs are published on https://cocoapods.org/pods/IdentitySdkCore[Cocoapods^] as independent modules. The latest version is `{sdk-ios-latest-version}`.

TIP: You can also find releases directly on the {company} repo at link:https://github.com/ReachFive/identity-ios-sdk/releases/[ReachFive iOS SDK^].
