...
* `domain` (required): the domain dedicated to the client, this parameter will be used by the SDK to establish calls to the APIs; give it as a bare host, with no `https://` prefix
