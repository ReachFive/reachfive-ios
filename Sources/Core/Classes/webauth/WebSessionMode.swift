...
/// - **in-band** (``inSheet``) : la redirection finale est interceptée DANS la webview de la session,
...
enum WebSessionMode {
    /// Complétion DANS la feuille : le completion handler de la session se déclenche.
    enum InSheet {
